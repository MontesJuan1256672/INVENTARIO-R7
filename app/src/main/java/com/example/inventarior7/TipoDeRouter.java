/*Si el usuario elige la opción de "Router" para dar de alta te envia a esta actividad en la que
 * se elige que tipo de router es el que se va a entrar o salir.
 *
 * Se presentan diferentes opciones. Las 9 primeras se usarán para grabar que tipo de
